...
namespace CopyForex.Server {
    /// <summary>
    /// This class implements Chat Service Contract.
    /// </summary>
    internal class MsgService : ScsService, IMsgService {
        ...
        public void Login(UserInfo userInfo) {
            ...
            var clientProxy = client.GetClientProxy<IMsgClient>();
        ...
        /// <param name="message">Message to be sent</param>
        public void SendPrivateMessage(string destinationNick, MessageData message) {
        ...
        private sealed class ChatClient {
            ...
            /// </summary>
            public IMsgClient ClientProxy { get; private set; }
            ...
            public ChatClient(IScsServiceClient client, IMsgClient clientProxy, UserInfo userInfo) {
                Client = client;
